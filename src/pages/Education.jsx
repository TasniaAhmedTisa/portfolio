  ...
  return (
      <section className="py-28 bg-gray-100">
          <div className="container mx-auto px-6">
              <h2 className="text-4xl font-bold text-center text-gray-800 mb-10">Education Qualification</h2>

              <div className="max-w-3xl mx-auto space-y-8">
                  {/* Bachelor's Degree */}
                  <div className="bg-gradient-to-r from-white skeleton to-cyan-200 hover:from-cyan-100 hover:to-blue-400 transition-all p-6 rounded-lg shadow-md">
                  ...
                  {/* High School */}
                  <div className="bg-gradient-to-r from-white skeleton to-cyan-200 hover:from-cyan-400 hover:to-blue-400 transition-all p-6 rounded-lg shadow-md">
