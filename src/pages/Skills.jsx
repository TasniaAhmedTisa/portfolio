    ...
    return (
        <section className="py-28 bg-gray-100 text-center">
            <div className="container mx-auto px-6">
                ...
                {/* Frontend Skills */}
                <div className="mb-10">
                    <h3 className="text-2xl font-semibold text-gray-700 mb-3">Frontend Development</h3>
                ...
                {/* Backend Skills */}
                <div className="mb-10">
                    <h3 className="text-2xl font-semibold text-gray-700 mb-3">Backend Development</h3>
                    <div className="flex flex-wrap gap-4 justify-center">
                        <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-md hover:bg-gray-200 transition">
                ...
                {/* Tools & Other Skills */}
                <div>
                    <h3 className="text-2xl font-semibold text-gray-700 mb-3">Tools & Other Skills</h3>
                    <div className="flex flex-wrap gap-4 justify-center">
                        <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-md hover:bg-gray-200 transition">
