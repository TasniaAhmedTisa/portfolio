        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {projectsData.projects.map(project => (
            <div key={project.id} className="bg-white rounded-lg shadow-lg p-6">
              ...
              <Link to={`/project-details/${project.id}`} className="btn text-black bg-gradient-to-r from-green-500 to-blue-400 hover:from-cyan-400 hover:to-blue-400 transition-all">
                View More
              </Link>
            </div>
          ))}
